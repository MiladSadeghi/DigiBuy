...
class editProduct extends HTMLElement {
  constructor() {
    ...
    this.productAddForm.classList.toggle("areas");
    this.productAddForm.classList.toggle("areas-template");
    ...
    this.submitProductBtn.insertAdjacentHTML("afterend", `<button id="delete-product"  type="button" class="btn btn-danger pr-de mb-3">Delete Product</button>`);
    this.deleteProductBtn = this.shadowRoot.querySelector("#delete-product");
  ...
  deleteProduct = async (e, product) => {
    if (confirm("Are you sure you want to delete this product?")) {
      let api = `https://digibuy-da839-default-rtdb.europe-west1.firebasedatabase.app/product/${product.productID}.json`;
